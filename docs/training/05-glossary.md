...
> **See also:** [Architecture Overview](01-architecture-overview.md) · [Provider System](02-provider-system.md) · [Agent Core](03-agent-core.md) · [Coding Agent](04-coding-agent.md) · [Build Your Own Agent](05-building-your-own.md) · [Add a Provider](06-adding-a-provider.md)
...
**Source:** `BotNexus.AgentCore` — Agent hook delegates
**Training:** [Agent Core — Hooks](03-agent-core.md)
...
**Source:** `BotNexus.AgentCore.Agent`
**Training:** [Agent Core](03-agent-core.md) · [Build Your Own Agent](05-building-your-own.md)
...
**Source:** `BotNexus.AgentCore`
**Training:** [Agent Core — State Management](03-agent-core.md)
...
**Source:** `BotNexus.AgentCore.Events`
**Training:** [Agent Core — Events](03-agent-core.md)
...
**Source:** `BotNexus.AgentCore.Loop`
**Training:** [Agent Core — The Loop](03-agent-core.md)
...
**Source:** `BotNexus.AgentCore`
**Training:** [Agent Core — Tool Execution](03-agent-core.md)
...
**Training:** [Provider System — Registry](02-provider-system.md)
...
**Training:** [Provider System — Message Types](02-provider-system.md)
...
**Source:** `BotNexus.Providers.Core.Streaming`
**Training:** [Provider System — Streaming](02-provider-system.md)
...
**Training:** [Coding Agent — Hooks](04-coding-agent.md)
...
**Source:** `BotNexus.Providers.Core.Models`
**Training:** [Provider System](02-provider-system.md)
...
**Source:** `BotNexus.CodingAgent`
**Training:** [Coding Agent](04-coding-agent.md) · [Build Your Own Agent](05-building-your-own.md)
...
**Source:** `BotNexus.CodingAgent`
**Training:** [Coding Agent — Configuration](04-coding-agent.md)
...
**Source:** `BotNexus.Providers.Core.Models`
**Training:** [Provider System — Message Types](02-provider-system.md) · [Architecture Overview](01-architecture-overview.md)
...
**Source:** `BotNexus.AgentCore`
**Training:** [Agent Core](03-agent-core.md)
...
**Source:** `BotNexus.CodingAgent`
**Training:** [Coding Agent — Extensions](04-coding-agent.md) · [Build Your Own Agent](05-building-your-own.md)
...
**Source:** `BotNexus.CodingAgent`
**Training:** [Coding Agent — Extensions](04-coding-agent.md)
...
**Source:** `BotNexus.AgentCore`
**Training:** [Agent Core — Tool Execution](03-agent-core.md) · [Build Your Own Agent](05-building-your-own.md)
...
**Source:** `BotNexus.Providers.Core`
**Training:** [Provider System](02-provider-system.md) · [Add a Provider](06-adding-a-provider.md)
...
**Source:** `BotNexus.Providers.Core`
**Training:** [Provider System](02-provider-system.md) · [Architecture Overview](01-architecture-overview.md)
...
**Source:** `BotNexus.Providers.Core.Models`
**Training:** [Provider System — Model Registry](02-provider-system.md)
...
**Source:** `BotNexus.Providers.Core`
**Training:** [Provider System — Model Registry](02-provider-system.md) · [Architecture Overview](01-architecture-overview.md)
...
**Source:** `BotNexus.AgentCore`
**Training:** [Agent Core — Steering](03-agent-core.md)
...
**Source:** `BotNexus.CodingAgent`
**Training:** [Coding Agent — Safety](04-coding-agent.md)
...
**Source:** `BotNexus.CodingAgent`
**Training:** [Coding Agent — Sessions](04-coding-agent.md)
...
**Source:** `BotNexus.CodingAgent`
**Training:** [Coding Agent](04-coding-agent.md)
...
**Source:** `BotNexus.AgentCore`
**Training:** [Agent Core — Events](03-agent-core.md) · [Provider System — Streaming](02-provider-system.md)
...
**Source:** `BotNexus.CodingAgent`
**Training:** [Coding Agent — System Prompt](04-coding-agent.md)
