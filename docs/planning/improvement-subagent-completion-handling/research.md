...
| `Agent` | `src/agent/BotNexus.AgentCore/Agent.cs` | Follow-up queue, run lifecycle |
| `AgentLoopRunner` | `src/agent/BotNexus.AgentCore/Loop/AgentLoopRunner.cs` | Follow-up drain at end of loop |
| `PendingMessageQueue` | `src/agent/BotNexus.AgentCore/PendingMessageQueue.cs` | Thread-safe message queue |
