...
| [improvement-gateway-detached-process](improvement-gateway-detached-process/design-spec.md) | 🟡 medium | draft | Jul '26 | Launch gateway as detached process from CLI with PID tracking |
