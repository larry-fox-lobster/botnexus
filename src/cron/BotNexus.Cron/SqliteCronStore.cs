...
public sealed class SqliteCronStore(string dbPath) : ICronStore
{
        ...
        try
        {
            ...
            command.CommandText = """
                INSERT INTO cron_jobs (
                    ...
                    enabled, created_by, created_at, last_run_at, next_run_at, last_run_status, last_run_error, metadata_json
                )
                VALUES (
                    $id, $name, $schedule, $actionType, $agentId, $message, $webhookUrl, $shellCommand,
                    $enabled, $createdBy, $createdAt, $lastRunAt, $nextRunAt, $lastRunStatus, $lastRunError, $metadataJson
                )
                """;
    ...
    private static CronJob ReadJob(SqliteDataReader reader)
    {
        ...
        return new CronJob
        {
            ...
            LastRunAt = reader.IsDBNull(11) ? null : ParseDate(reader.GetString(11)),
            NextRunAt = reader.IsDBNull(12) ? null : ParseDate(reader.GetString(12)),
            LastRunStatus = reader.IsDBNull(13) ? null : reader.GetString(13),
            LastRunError = reader.IsDBNull(14) ? null : reader.GetString(14),
