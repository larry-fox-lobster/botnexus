...
**Agent:** Farnsworth  
**Scope:** BotNexus.AgentCore project and foundation types

## Summary

Scaffolded new `BotNexus.AgentCore` project with foundation types (messages, tools, state, execution pipeline). Initial build had cross-project references that violated the new constraint (only `src/providers/` allowed). Fixed all references. Build clean.

## Work Completed

1. Created `src/agent/BotNexus.AgentCore/` project  
